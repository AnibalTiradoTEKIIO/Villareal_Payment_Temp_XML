...
<cfdi:Comprobante xmlns:pago20="http://www.sat.gob.mx/Pagos20" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:cfdi="http://www.sat.gob.mx/cfd/4" xsi:schemaLocation="http://www.sat.gob.mx/cfd/4 http://www.sat.gob.mx/sitio_internet/cfd/4/cfdv40.xsd http://www.sat.gob.mx/Pagos20 http://www.sat.gob.mx/sitio_internet/cfd/Pagos/Pagos20.xsd"
    ...
    <#elseif transaction.custbody_efx_fe_factoraje_zip?has_content>
    ...
    <cfdi:Complemento>
        <pago20:Pagos Version="2.0">
            ...
            <#assign montoTotalPagoFactoraje = 0>
            ...
            <#list custom.appliedTxns as appliedTxn>
                    ...
                    <#list impuestosPago.bases_iva as ivaRate, ivaValue>
                        ...
                        <#if ivaRate=="16">
                            ...
                            <#else>
                                ...
                                <#assign totaltrasladosiva16div = totaltrasladosiva16div+(((txnitem.amount?string["0.00"]?number)/1.16)?string["0.00"]?number)>
                                <#--  <#assign totaltrasladosiva16div = (totaltrasladosiva16div+(((impuestosPago.rates_iva_data[ivaRate]?number*equivalenciaImpuesto)?string["0.00"]?number)/0.16)?string["0.00"]?number)>  -->
                            </#if>
                ...
                <#assign montoTotalPago = ((montoTotalPago + txnitem.amount)?string["0.00;;roundingMode=down"])?number>
                <#--  <#assign montoTotalPago = montoTotalPago+txnitem.amount>  -->
                <#if transaction.custbody_efx_fe_chbx_factorage == true>
                    <#assign montoTotalPagoFactoraje = ((montoTotalPagoFactoraje + txnitem.disc)?string["0.00"])?number>
                </#if>
                <#--  <#assign montoTotalPago = montoTotalPago+txnitem.amount>  -->
            </#list>
            ...
            <#if transaction.custbody_efx_fe_chbx_factorage == true>
                <#assign monto_total_pago_factoraje = montoTotalPago + montoTotalPagoFactoraje>
            </#if>
            ...
            <pago20:Totales
                ...
                <#elseif currencyCode=="USD">
                    MontoTotalPagos="${(monto_total_pago*(tipo_cambio_pago?string["0.0000"])?number)?string["0.00"]}"
                    <#--  MontoTotalPagos="${(monto_total_pago*(tipo_cambio_pago?string["0.0000"])?number)?string["0.00;;roundingMode=up"]}"  -->
                <#else>
                    <#if transaction.custbody_efx_fe_chbx_factorage == true>
                        MontoTotalPagos="${monto_total_pago_factoraje?string["0.00"]}"
                    <#else>
                        MontoTotalPagos="${montoTotalPago?string["0.00"]}"
                    </#if>
                </#if>
            <#if esTrasladoIva==true>
                <#if totaltrasladosiva16base gt 0>
                    <#if transaction.custbody_efx_fe_moneda.symbol == "USD" && transaction.currencysymbol == "MXN"> 
                        <#assign base_multiomneda = (totaltrasladosiva16div / tipocambioCustom)?string["0.00"]> 
                        TotalTrasladosBaseIVA16="${(base_multiomneda?number * tipocambioCustom)?string["0.00"]}"
                    <#elseif transaction.custbody_efx_fe_moneda.symbol == "MXN" && transaction.currencysymbol == "USD">
                        TotalTrasladosBaseIVA16="${(totaltrasladosiva16div/tipocambioCustom)?string("##0.00;; roundingMode=down")}"
                    <#elseif currencyCode=="EUR">
                        TotalTrasladosBaseIVA16="${(totaltrasladosiva16div*transaction.exchangerate)?string["0.00"]}"
                    <#elseif currencyCode=="USD">
                        TotalTrasladosBaseIVA16="${(totaltrasladosiva16div*(transaction.exchangerate?string["0.0000"])?number)?string("0.00")}"
                        <#--  TotalTrasladosBaseIVA16="${(totaltrasladosiva16div*(transaction.exchangerate?string["0.0000"])?number)?string("##0.00;; roundingMode=halfDown")}"  -->
                    <#elseif currencyCode==transaction.custbody_efx_fe_moneda.symbol>
                        TotalTrasladosBaseIVA16="${(totaltrasladosiva16div*transaction.exchangerate)?string["0.00"]}"
                    <#else>
                        <#if transaction.custbody_efx_fe_chbx_factorage == true>
                            TotalTrasladosBaseIVA16="${((monto_total_pago_factoraje)?number/1.16)?string("0.00")}"
                        <#else>
                            TotalTrasladosBaseIVA16="${((monto_total_pago)?number/1.16)?string("0.00")}"
                            <#--  TotalTrasladosBaseIVA16="${((monto_total_pago)?number/1.16)?string("0.00;;roundingMode=down")}"  -->
                            <#--  TotalTrasladosBaseIVA16="${((monto_total_pago?string("0.##;;roundingMode=floor"))?number/1.16)?string("0.00")}"  -->
                        </#if>
                    </#if>
                    <#--  TotalTrasladosBaseIVA16="${(monto_total_pago/1.16)?string("##0.00;; roundingMode=down")}"</#if>  -->
                    <#if transaction.custbody_efx_fe_moneda.symbol == "USD" && transaction.currencysymbol == "MXN">
                        <#assign ImportePIVA16 = (totaltrasladosiva16)>
                        <#assign importe_multimoneda = (totaltrasladosiva16 / tipocambioCustom)?string["0.00"]>
                        TotalTrasladosImpuestoIVA16="${(importe_multimoneda?number * tipocambioCustom)?string["0.00"]}"
                    <#elseif transaction.custbody_efx_fe_moneda.symbol == "MXN" && transaction.currencysymbol == "USD">
                        <#assign ImportePIVA16 = (totaltrasladosiva16/tipocambioCustom)?string("##0.00;; roundingMode=down")>
                        TotalTrasladosImpuestoIVA16="${(totaltrasladosiva16/tipocambioCustom)?string("##0.00;; roundingMode=down")}"
                    <#elseif currencyCode=="EUR">
                        TotalTrasladosImpuestoIVA16="${(totaltrasladosiva16*transaction.exchangerate)?string["0.00"]}"
                        <#assign ImportePIVA16 = (totaltrasladosiva16*transaction.exchangerate)?string["0.00"]>
                    <#elseif currencyCode=="USD">
                        TotalTrasladosImpuestoIVA16="${(totaltrasladosiva16*(transaction.exchangerate?string["0.0000"])?number)?string("##0.00;; roundingMode=halfUp")}"
                        <#assign ImportePIVA16 = (totaltrasladosiva16*transaction.exchangerate)?string("##0.00;; roundingMode=halfUp")>
                    <#elseif currencyCode==transaction.custbody_efx_fe_moneda.symbol>
                        TotalTrasladosImpuestoIVA16="${(totaltrasladosiva16*transaction.exchangerate)?string["0.00"]}"
                        <#assign ImportePIVA16 = (totaltrasladosiva16*transaction.exchangerate)?string["0.00"]>
                    <#else>
                        <#if transaction.custbody_efx_fe_chbx_factorage == true>
                            TotalTrasladosImpuestoIVA16="${(((monto_total_pago_factoraje/1.16)?string["0.00"]?number)*0.16)?string["0.00"]}"
                            <#assign ImportePIVA16 = totaltrasladosiva16?string["0.00"]>
                        <#else>
                            TotalTrasladosImpuestoIVA16="${totaltrasladosiva16?string["0.00"]}"
                            <#assign ImportePIVA16 = totaltrasladosiva16?string["0.00"]>
                        </#if>
                    </#if>
                </#if>
                ...
                <#if totaltrasladosiva0base gt 0>
                    <#if transaction.custbody_efx_fe_moneda.symbol == "MXN" && transaction.currencysymbol == "USD">
                        TotalTrasladosBaseIVA0="${(totaltrasladosiva0div)?string("##0.00;; roundingMode=down")}"
                    <#elseif currencyCode=="USD" || currencyCode=="EUR">
                        TotalTrasladosBaseIVA0="${(totaltrasladosiva0base * transaction.exchangerate)?string["0.00;;roundingMode=up"]}"
                    <#else>
                        TotalTrasladosBaseIVA0="${totaltrasladosiva0base?string["0.00"]}"</#if>
                                        ...
                                        <#if impuestosPago.bases_iva?has_content || impuestosPago.bases_ieps?has_content>
                                            <pago20:TrasladosDR>
                                                <#list impuestosPago.bases_iva as ivaRate, ivaValue>
                                                    ...
                                                    <#if ImpuestosPTraslados_base?has_content>
                                                        ...
                                                        <#list ImpuestosPTraslados_base?keys as key>
                                                            ...
                                                            <#if key == ivaRate>
                                                                ...
                                                                <#assign "total_rate" = ImpuestosPTraslados_base[key]?number + ((ivaValue?number*equivalenciaImpuesto)?string['0.000'])?number>
                                                        ...
                                                        <#if conteos == 0>
                                                            <#assign "ImpuestosPTraslados_base"= ImpuestosPTraslados_base + {ivaRate : ((ivaValue?number*equivalenciaImpuesto)?string['0.000'])?number}>
                                                    ...
                                                    <#if ImpuestosPTraslados_importe?has_content>
                                                        ...
                                                        <#list ImpuestosPTraslados_importe?keys as key>
                                                            ...
                                                            <#if key == ivaRate>
                                                                ...
                                                                <#assign "total_rate" = ImpuestosPTraslados_importe[key]?number + ((impuestosPago.rates_iva_data[ivaRate]?number * equivalenciaImpuesto)?string['0.000'])?number>
                                                        ...
                                                        <#if conteos == 0>
                                                            <#assign "ImpuestosPTraslados_importe"= ImpuestosPTraslados_importe + {ivaRate : ((impuestosPago.rates_iva_data[ivaRate]?number*equivalenciaImpuesto)?string['0.000'])?number}>
                                                    ...
                                                    <#assign montoimpuestosPagoDR = ((txnitem.amount)?string["0.00"]?number)>
                                                    <#assign rateimpuestosPago = (ivaRate?number/100)?string["0.00"]>
                                                      <#assign rateimpuestosPagoDR = ((ivaRate?number/100)+1)?string["0.00"]>
                                                    ...
                                                    <pago20:TrasladoDR BaseDR="${((montoimpuestosPagoDR/ rateimpuestosPagoDR?number))?string['0.00']}" ImpuestoDR="002" TipoFactorDR="Tasa" TasaOCuotaDR="${rateDR?string['0.000000']}" ImporteDR="${(impuestosPago.rates_iva_data[ivaRate]?number*equivalenciaImpuesto)?string['0.00']}"/>
                                                </#list>
                                            ...
                                            <pago20:TrasladosDR>
                                                <#list impuestosPago.bases_iva as ivaRate, ivaValue>
                                                    ...
                                                    <#if ImpuestosPTraslados_importe?has_content>
                                                        ...
                                                        <#list ImpuestosPTraslados_importe?keys as key>
                                                            <#if key == ivaRate>
                                                                ...
                                                                <#if ivaRate?number gt 0 && impuestosPago.rates_iva_data[ivaRate]?number gt 0>
                                                                    <#assign "total_rate" = ImpuestosPTraslados_importe[key]?number + (((impuestosPago.rates_iva_data[ivaRate]?number*equivalenciaImpuesto)?string['0.000'])?number/tasaCuota)?string["0.000"]?number>
                                                                ...
                                                                <#else>
                                                                    <#assign "total_rate" = ImpuestosPTraslados_importe[key]?number + (((impuestosPago.rates_iva_data[ivaRate]?number*equivalenciaImpuesto)?string['0.000'])?number)?string["0.0"]?number>
                                                        ...
                                                        <#if conteos == 0>
                                                            <#if ivaRate?number gt 0 && impuestosPago.rates_iva_data[ivaRate]?number gt 0>
                                                                <#assign "ImpuestosPTraslados_importe"= ImpuestosPTraslados_importe + {ivaRate : (((impuestosPago.rates_iva_data[ivaRate]?number*equivalenciaImpuesto)?string['0.000'])?number/tasaCuota)?string["0.000"]?number}>
                                                            ...
                                                            <#else>
                                                                <#assign "ImpuestosPTraslados_importe"= ImpuestosPTraslados_importe + {ivaRate : (((impuestosPago.rates_iva_data[ivaRate]?number*equivalenciaImpuesto)?string['0.000'])?number)?string["0.000"]?number}>
                                                    ...
                                                    <#assign rateDR = ivaRate?number/100>
                                                    <#--  <#assign montoimpuestosPago = ((impuestosPago.rates_iva_data[ivaRate]?number)*equivalenciaImpuesto)?string['0.0000']?number>  -->
                                                    <#assign montoimpuestosPago = ((txnitem.amount)?string["0.00"]?number)>
                                                    <#--  <#assign montoimpuestosPago = ((impuestosPago.rates_iva_data[ivaRate]?number)*equivalenciaImpuesto)?string['0.00']?number>  -->
                                                    ...
                                                    <pago20:TrasladoDR
                                                        <#if montoimpuestosPago gt 0>
                                                            <#if transaction.currencysymbol == "USD">
                                                                <#if rateimpuestosPago?number?string["0.00"] == "0.16">
                                                                    BaseDR="${((montoimpuestosPago/1.16?number))?string['0.00']}"
                                                                <#elseif rateimpuestosPago?number?string["0.00"] == "0.08">
                                                                    BaseDR="${((montoimpuestosPago/1.08?number))?string['0.00']}"
                                                                <#else>
                                                            ...
                                                            <#else>
                                                                <#if rateimpuestosPago?number?string["0.00"] == "0.16">
                                                                    ...
                                                                    <#--  BaseDR="${((((txnitem.amount)/1.16)?string["#.##;;roundingMode=floor"])?number)?string['0.##']}"  -->
                                                                    <#--  <#assign suma_baseDR = suma_baseDR + (((txnitem.amount)/1.16)?string["#.##;;roundingMode=floor"])?number>  -->
                                                                    <#assign suma_baseDR = suma_baseDR + (((txnitem.amount)/1.16)?string["0.00"])?number>
                                                                    <#--  <#assign suma_baseDR = suma_baseDR + (((txnitem.amount)/1.16)?string["0.00"])?number>  -->
                                                        ...
                                                        ImpuestoDR="002" TipoFactorDR="Tasa" TasaOCuotaDR="${rateDR?string['0.000000']}" 
                                                        ImporteDR="${(impuestosPago.rates_iva_data[ivaRate]?number*equivalenciaImpuesto)?string['0.00']}"/>
                                                </#list>
                                                <#if desglosa_ieps == true>
                                                    <#list impuestosPago.bases_ieps as iepsRate, iepsValue>
                            ...
                            <pago20:TrasladosP>
                                <#list ImpuestosPTraslados_base as baseTkey, baseTvalue>
                                    ...
                                    <#if ImpuestosPTraslados_importe[baseTkey]?number gt 0>
                                        ...
                                        <#--  mod  -->
                                            <#if rateimpuestosPago?number?string["0.00"] == "0.16">
                                                <#assign basePmonto = ((monto_total_pago/1.16)?string("0.00")?number)>
                                            <#else>
                                                <#assign basePmonto = ((ImpuestosPTraslados_importe[baseTkey]?string["0.00"]?number)/tipocambioCustom)?string["0.00"]?number>
                                            </#if>
                                            <#--  <#assign basePmonto = ((ImpuestosPTraslados_importe[baseTkey]?string["0.##;;roundingMode=floor"]?number)/tipocambioCustom)?string["0.000"]?number>  -->

                                            <#--  <#assign basePmonto = (ImpuestosPTraslados_importe[baseTkey])/tipocambioCustom>  -->
                                    ...
                                    <#if desglosa_ieps == true>
                                        ...
                                        <#if impuestoPType!="003">
                                            ...
                                            <#elseif transaction.custbody_efx_fe_moneda?has_content == false && transaction.currencysymbol == "USD">                                                        
                                                <#assign rateimpuestosPago =(ivaRate?number/100)>
                                                <#assign importP=(basePmonto?number*rateimpuestosPago?number)>
                                    
                                                <pago20:TrasladoP BaseP="${basePmonto?string['0.00']}" ImpuestoP="${impuestoPType}" TipoFactorP="Tasa" TasaOCuotaP="${tasaCuota?string['0.000000']}" ImporteP="${importP?string['0.00']}"/>
                                            <#else>
                                                <#if suma_baseDR gt 0>
                            ...
                            <pago20:TrasladosP>
                                <#list ImpuestosPTraslados_base as baseTkey, baseTvalue>
                                    ...
                                    <#if ImpuestosPTraslados_importe[baseTkey]?number gt 0>
                                        ...
                                        <#else>
                                            <#--  <#assign basePmonto = basePmonto + (((montoimpuestosPago/ rateimpuestosPago?number))?string['0.00'])?number>  -->
                                    ...
                                    <#else>
                                        <#if transaction.custbody_efx_fe_moneda.symbol == "MXN" && transaction.currencysymbol == "USD">
                                            <#assign basePmonto = (baseTvalue?number/transaction.custbody_efx_fe_tipo_cambio)?string("##0.00;; roundingMode=down")?number>
                                        <#else>
                                            <#assign basePmonto = basePmonto + (((montoimpuestosPago/ rateimpuestosPago?number))?string['0.000'])>
                                            <#--  <#assign basePmonto = baseTvalue?number>  -->
                                        </#if>
                                    </#if>
